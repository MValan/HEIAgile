...
<jsp:include page="../navbar.jsp">
	...
	<div>
		...
		<div id="emptyBooks" class="alert alert-warning"
			style="display: none;">
			Il n'y a aucun livre enregistré (ou disponible) en Base de Données.<strong>
				Veuillez d'abord en ajouter un <a href='../books/books'>ici.</a>
			</strong>
		</div>

		<div id="emptyMembers" class="alert alert-warning"
			style="display: none;">
			Il n'y a aucun membre enregistré en Base de Données.<strong>
				Veuillez d'abord en ajouter un <a href='../members/members'>ici.</a>
			</strong>
		</div>
		...
		<form:form method="POST" id="insertBorrow" commandName="borrow"
			...
			<div class="row">
				<label class="col-sm-3 control-label" for="titleBook">Membre*
					:</label>
			...
			<div class="row">
				<label class="col-sm-3 control-label" for="dateBorrow">Date
					maximale de restitution :</label>

				<div class="col-sm-5">
					<form:input path="dateBorrowEnd" class="form-control" type="date"
						name="dateBorrow" id="dateBorrow" value="${dateRest}"
						readonly="true" />
				</div>
				<div class="message-erreur"></div>
			</div>
