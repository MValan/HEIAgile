...
<html>
	<head>
		...
		<link rel="stylesheet" href="http://oss.maxcdn.com/jquery.bootstrapvalidator/0.5.2/css/bootstrapValidator.min.css">
		...
		<div class="container">
			...
			<form id="isbnForm" class="form-horizontal">
			    <div id="isbn-form" class="form-group">
			    	<div class="row">
			        <label class="col-sm-3 control-label">ISBN * (<i>9971502100</i>)</label>
			        <div class="col-sm-5">
			            <input type="text" id="input-isbn" class="form-control" name="isbn"/>
			        </div>
			        </div>
			    </div>
			</form>
			...
			<form:form method="POST" commandName="book" class="form-horizontal">
			   <div class="form-group">
			  	...
			  	<div class="row">
				    ...
				    <div class="col-sm-5">
				      <form:input path="titleBook" placeholder="Titre de l'ouvrage" required="required"/>
				    </div>
			    </div>
			  
			  	<div class="row">
				    <label class="col-sm-3 control-label" for="priceBook">Prix d'achat</label>
				    <div class="col-sm-5">
				      <form:input path="priceBook" class="numericOnly" placeholder="Prix d'achat en euro" required="required"/>
				    </div>
			    </div>
